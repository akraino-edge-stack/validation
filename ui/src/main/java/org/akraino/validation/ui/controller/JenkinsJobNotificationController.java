...
public class JenkinsJobNotificationController extends RestrictedBaseController {
    ...
    private EELFLoggerDelegate LOGGER = EELFLoggerDelegate.getLogger(JenkinsJobNotificationController.class);
    ...
    public ResponseEntity<Void> handle(@RequestBody JnksJobNotify jnksJobNotify) {
        try {
            ...
            LOGGER.error(EELFLoggerDelegate.errorLogger, "Error when trying to process Jenkins notification", e);
        }
