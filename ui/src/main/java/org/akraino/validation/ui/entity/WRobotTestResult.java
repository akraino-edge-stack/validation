...
public class WRobotTestResult implements Serializable {
    ...
    private ValidationTestResult vResult;
    ...
    public void setValidationTestResult(ValidationTestResult vResult) {
