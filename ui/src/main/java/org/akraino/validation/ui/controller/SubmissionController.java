...
public class SubmissionController extends RestrictedBaseController {
    ...
    private EELFLoggerDelegate LOGGER = EELFLoggerDelegate.getLogger(SubmissionController.class);
    ...
    public ResponseEntity<List<Submission>> getSubmissions() {
        try {
            ...
            LOGGER.error(EELFLoggerDelegate.errorLogger, "Get of submissions failed", e);
        }
    ...
    public ResponseEntity<Submission> postSubmission(@RequestBody Submission newSubmission) {
        try {
            ...
            LOGGER.error(EELFLoggerDelegate.errorLogger, "Post of submission failed", e);
        }
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(null);
    }
    ...
    public ResponseEntity<Boolean> deleteSubmission(@RequestBody Submission submission) {
        try {
            ...
            LOGGER.error(EELFLoggerDelegate.errorLogger, "Deletion of submission failed", e);
        }
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(null);
    }
