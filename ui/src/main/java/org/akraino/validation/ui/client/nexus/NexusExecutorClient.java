...
public final class NexusExecutorClient {
    ...
    public NexusExecutorClient(String newBaseurl) {
        ...
        client = new Client(new URLConnectionClientHandler(new HttpURLConnectionFactory() {
            ...
            public HttpURLConnection getHttpURLConnection(URL url) throws IOException {
                try {
                    String proxyIp = PropertyUtil.getInstance().getProperty("proxy.ip");
                    String proxyPort = PropertyUtil.getInstance().getProperty("proxy.port");
        ...
        trustAllCertificates = new TrustManager[] {new X509TrustManager() {
            @Override
    ...
    private void setProperties() throws NoSuchAlgorithmException, KeyManagementException {
        ...
        sslContext.init(null, this.trustAllCertificates, new java.security.SecureRandom());
