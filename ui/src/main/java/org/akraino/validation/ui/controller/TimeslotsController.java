...
public class TimeslotsController extends RestrictedBaseController {
    ...
    private EELFLoggerDelegate LOGGER = EELFLoggerDelegate.getLogger(TimeslotsController.class);
    ...
    public ResponseEntity<List<Timeslot>> getTimeSlots() {
        try {
            ...
            LOGGER.error(EELFLoggerDelegate.errorLogger, "Error occured when trying to retrieve timeslots", e);
        }
