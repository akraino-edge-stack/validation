        ...
        .controller(
                ...
                function($scope, restAPISvc) {
                    ...
                    $scope.selectedSubmissionChange = function(
                        ...
                        restAPISvc.getRestAPI("/api/results/getBySubmissionId/"
                                + id, function(data) {
                            $scope.results = data;
                            angular.forEach($scope.results, function(result) {
                                $scope.resultsNames.push(result.name);
                            });
                        });
                    }

                    $scope.selectedResultsNameChange = function(
                            selectedResultsName) {
                        angular.forEach($scope.results, function(result) {
                            if (result.name.trim() === selectedResultsName
                                    .trim()) {
