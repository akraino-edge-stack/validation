...
app.controller('AECGetAllResultsController', function ($scope, restAPISvc,
    ...
    $scope.dateTimeSort = function (bluvalResult) {
        return new Date(bluvalResult.dateOfStorage).getTime();
    }
