...
app.factory('generalGetAllResultsSvc', [function () {
    var svc = [];
    ...
    svc.filterWithLayer = function (timestampResults, filterLayer) {
        ...
        angular.forEach(timestampResults, function (timestampResult) {
            angular.forEach(timestampResult.wrapperRobotTestResults,
                function (wrapperRobotTestResult) {
                    if (wrapperRobotTestResult.blueprintLayer
