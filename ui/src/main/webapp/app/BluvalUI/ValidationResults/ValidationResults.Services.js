...
app
        .factory(
                ...
                [ function() {
                    var svc = [];
                    svc.getBlueprintLayers = function(validationDbTestResults) {
                        var layers = [];
                        angular.forEach(angular
                                .fromJson(validationDbTestResults), function(
                                validationDbTestResult) {
                            if (validationDbTestResult.layer !== undefined) {
                                layers.push(validationDbTestResult.layer);
                            }
                        });
                        return layers;
                    };
