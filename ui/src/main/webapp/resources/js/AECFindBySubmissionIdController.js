													...
													.forEach(
															...
															function(
																...
																var temp = "id: "
																		...
																		+ " blueprint: "
																		+ submissionData.blueprintData.blueprint
																		+ " version: "
																		+ submissionData.blueprintData.version
																		+ " layer: "
																		+ submissionData.blueprintData.layer
																		+ " lab: "
																		+ submissionData.blueprintData.timeslot.lab
																		+ " Start date and time: "
																		+ submissionData.blueprintData.timeslot.startDateTime
																		+ " duration: "
																		+ submissionData.blueprintData.timeslot.duration;
																$scope.submissionsForDisplay
																		.push(temp);
															});
										});
