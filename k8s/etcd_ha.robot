...
...               If the etcd node command line supports etcdctl3 then pass ${VERSION} as "3"
...               If the etcd node command line supports etcdctl then pass ${VERSION} as "null" or "empty"
