...
def run_testcase(testcase):
    ...
    show_stopper = False
    try:
        show_stopper = testcase['show_stopper']
    except KeyError:
        show_stopper = False
...
def parse_yaml(testcase_file):
    """Parse yaml file and do tasks on each testcase
    """
    with open(testcase_file) as testcase_file:
        testcase_yaml = yaml.safe_load(testcase_file)
        blueprint = testcase_yaml['blueprint']
