...
Get Robot Version
        ...
        Should Contain          ${stdout}               Robot Framework 3.1.1
...
Start Sonobuoy Conformance Test
        ...
        ${output}  ${rc}=       Execute Command      cat /opt/akraino/validation/conformance/sonobuoy.yaml | kubectl apply -f -    return_rc=True    sudo=True
