...
Verify mac address
    ...
    ${output}=        Run    curl ${BASE_URI} ${MTOOL_PY}
    Append To File    ${LOG}  ${output}${\n}
...
Verify chassis details
    ...
    ${output}=        Run
    ...   curl --user ${USERNAME}:${PASSWORD} ${BASE_URI}/Chassis/System.Embedded.1 ${MTOOL_PY}
    Append To File    ${LOG}  ${output}${\n}
...
Verify iDRAC settings
    ...
    ${output}=        Run
    ...   curl --user ${USERNAME}:${PASSWORD} ${BASE_URI}/Managers/iDRAC.Embedded.1/Attributes ${MTOOL_PY}
    Append To File    ${LOG}  ${output}${\n}
...
Verify boot registry
    ...
    ${output}=        Run
    ...   curl --user ${USERNAME}:${PASSWORD} ${BASE_URI}/Systems/System.Embedded.1/BootSources/BootSourcesRegistry ${MTOOL_PY}
    Append To File    ${LOG}  ${output}${\n}
...
Verify bios settings
    ...
    ${output}=        Run
    ...   curl --user ${USERNAME}:${PASSWORD} ${BASE_URI}/Systems/System.Embedded.1/Bios ${MTOOL_PY}
    Append To File    ${LOG}  ${output}${\n}
...
Verify firmware version
    ...
    ${output}=        Run
    ...   curl --user ${USERNAME}:${PASSWORD} ${BASE_URI}/UpdateService/FirmwareInventory ${MTOOL_PY}
    Append To File    ${LOG}  ${output}${\n}
