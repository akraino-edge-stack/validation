...
Verify chassis details
    ...
    ${output}=        Run
    ...   curl --user ${IPMIUSER}:${IPMIPWRD} ${BASE_URI}Chassis/System.Embedded.1 -k | python -m json.tool
    Append To File    ${LOG}  ${output}${\n}
...
Verify iDRAC settings
    ...
    ${output}=        Run
    ...   curl --user ${IPMIUSER}:${IPMIPWRD} ${BASE_URI}Managers/iDRAC.Embedded.1/Attributes -k | python -m json.tool
    Append To File    ${LOG}  ${output}${\n}
...
Verify boot registry
    ...
    ${output}=        Run
    ...   curl --user ${IPMIUSER}:${IPMIPWRD} ${BASE_URI}Systems/System.Embedded.1/BootSources/BootSourcesRegistry -k | python -m json.tool
    Append To File    ${LOG}  ${output}${\n}
...
Verify bios settings
    ...
    ${output}=        Run
    ...   curl --user ${IPMIUSER}:${IPMIPWRD} ${BASE_URI}Systems/System.Embedded.1/Bios -k | python -m json.tool
    Append To File    ${LOG}  ${output}${\n}
...
Verify firmware version
    ...
    ${output}=        Run
    ...   curl --user ${IPMIUSER}:${IPMIPWRD} ${BASE_URI}UpdateService/FirmwareInventory -k | python -m json.tool
    Append To File    ${LOG}  ${output}${\n}
